          ...
          <div className="flex flex-col items-center justify-center min-h-[calc(100vh-180px)] px-4 sm:px-6 lg:px-8 py-12 sm:py-20">
             ...
             <form onSubmit={handleSubmit} className="w-full max-w-2xl px-4">
               <div className="relative">
                 ...
                 >
                    <div className="flex items-center px-4 sm:px-6 py-2 sm:py-2.5">
                    ...
                    <div className="flex-1 relative">
                      <input
                       ...
                       placeholder={t.chatPlaceholder}
                        className="w-full px-4 py-2 sm:py-2.5 bg-slate-50 border-2 border-slate-200 rounded-xl sm:rounded-2xl outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-base appearance-none"
